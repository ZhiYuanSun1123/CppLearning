...
const std::string& AudioClip::path() const noexcept {
    return path_;
}

int AudioClip::sample_rate() const noexcept {
    return sample_rate_;
}

int AudioClip::channels() const noexcept {
    return channels_;
}

std::size_t AudioClip::frame_count() const noexcept {
    return frame_count_;
}
